...
| **Kali Linux** | Profissionais de segurança, hackers éticos | Centenas de ferramentas de pentest e forense já incluídas | Não é amigável para iniciantes, pouco prático para uso diário |
| **Lubuntu** | Usuários com PCs antigos ou fracos | Extremamente leve (LXQt), rápido, eficiente | Interface simples, menos recursos e polimento |
